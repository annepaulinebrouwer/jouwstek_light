...
jojanneke_allotment.garden_reviews.create!(user: jojanneke, description: "Really good garden! Lots of sun so my tomaties turned out great", stars: 5)
carolien_allotment.garden_reviews.create!(user: carolien, description: "Nice garden! I planted some flowers in the back, but the rest was already well maintained", stars: 4)
...
paula.owner_reviews.create!(user: jojanneke, description: "Nice person, is a good gardener and gave me some of her tomatoes!", stars: 5)
paula.owner_reviews.create!(user: carolien, description: "Really nice person, planted some beautiful flowers in my garden. She is always welcome back", stars: 3)
